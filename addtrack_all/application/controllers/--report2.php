...
class report extends CI_Controller {
   ...
   header("Pragma: public");
    ...
    $first = true;
					...
					$this->xlsWriteLabel(0,0,'Sl');
					$this->xlsWriteLabel(0,1,'Date');
					$this->xlsWriteLabel(0,2,'Media Name');
					$this->xlsWriteLabel(0,3,'Publication Name');
					$this->xlsWriteLabel(0,4,'Publication Type');
					$this->xlsWriteLabel(0,5,'Publication Place');
					$this->xlsWriteLabel(0,6,'Publication Freq');
					$this->xlsWriteLabel(0,7,'Publication Language');
					$this->xlsWriteLabel(0,8,'Brand');
					$this->xlsWriteLabel(0,9,'Sub-Brand');
					$this->xlsWriteLabel(0,10,'Company');
					$this->xlsWriteLabel(0,11,'Product');
					$this->xlsWriteLabel(0,12,'Caption');
					$this->xlsWriteLabel(0,13,'Ad-type ');				
					$this->xlsWriteLabel(0,14,'Hue');
					$this->xlsWriteLabel(0,15,'Ad-theme');
					$this->xlsWriteLabel(0,16,'Page Name');
					$this->xlsWriteLabel(0,17,'Placing');
					$this->xlsWriteLabel(0,18,'Placing type');
					$this->xlsWriteLabel(0,19,'Column');
					$this->xlsWriteLabel(0,20,'Inch');
					$this->xlsWriteLabel(0,21,'ColumnXInch');
					$this->xlsWriteLabel(0,22,'Page No');
					$this->xlsWriteLabel(0,23,'Cost');
	...
	foreach( $qr  as  $qrow   )
    {
		 	...
		 	$this->xlsWriteLabel( $row,0,  $i  );
			$this->xlsWriteLabel( $row, 1,  $qrow->Date  );
			$this->xlsWriteLabel( $row, 2,  $qrow->MediaId );
			$this->xlsWriteLabel( $row, 3,   $qrow->PublicationName);
			$this->xlsWriteLabel( $row, 4,   $qrow->PublicationType );
			$this->xlsWriteLabel( $row, 5,  $qrow->PublicationPlace );  
			$this->xlsWriteLabel( $row, 6,   $qrow->PublicationFreq);
			$this->xlsWriteLabel( $row,7,   $qrow->PublicationLan );
			$this->xlsWriteLabel( $row,8,   $qrow->Brand );
			$this->xlsWriteLabel( $row, 9,   $qrow->Subbrand );
			$this->xlsWriteLabel( $row, 10,  $qrow->Company );
			$this->xlsWriteLabel( $row, 11,   $qrow->ProductName  );
			$this->xlsWriteLabel( $row, 12,   $qrow->Caption );
			$this->xlsWriteLabel( $row, 13,   $qrow->AdType  );  
			$this->xlsWriteLabel( $row, 14,   $qrow->HueName  );  
			$this->xlsWriteLabel( $row, 15,   $qrow->Adtheme  );  
			$this->xlsWriteLabel( $row, 16,   $qrow->PageNo  );  
			$this->xlsWriteLabel( $row, 17,   $qrow->PlaceingName  );  
			$this->xlsWriteLabel( $row, 18,   $qrow->PositionName  );  
			$this->xlsWriteLabel( $row, 19,   $qrow->Cols  );  
			$this->xlsWriteLabel( $row, 20,   $qrow->Inchs  );  
			$this->xlsWriteLabel( $row, 21,   $qrow->Cols * $qrow->Inchs  );  
			$this->xlsWriteLabel( $row, 22,   $qrow->PageNo  );  
			$this->xlsWriteLabel( $row, 23,   $qrow->Price  );  
