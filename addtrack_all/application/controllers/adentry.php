	  ...
	  function addmorerow($i=NULL )
	   {
        ...
        <td width=\"42\">$next</td>
        <td width=\"100\" ><input  tabindex=\"$next"."16\" name=\"ID$next\" id=\"ID$next\" onblur=\"loadcap($next)\" type=\"text\" value=\"\" size=\"20\"  style=\"width:100px\" /></td>
       <td width=\"100\" > ".form_dropdown("Caption$next", $cap,'0' ,"tabindex='".$next."17' onchange='loadid(".$next.")'  class='chzn-select' id='Caption$next' ")."</td>
		...
		<td width=\"70\"><select  tabindex=\"".$next."19\" name=\"pageno$next\" id=\"pageno$next\" class='a' style=\"width:70px\">
        ...
        <td width=\"65\"><input name=\"Cols$next\" id=\"Cols$next\" type=\"text\" value=\"\"  tabindex=\"".$next."23\" style=\"width:65px\" /></td>

<td width=\"41\">X</td>
		
        <td width=\"67\"><input name=\"Inchs$next\" id=\"Inchs$next\" type=\"text\" value=\"\" tabindex=\"".$next."24\"  style=\"width:67px\" /></td>
