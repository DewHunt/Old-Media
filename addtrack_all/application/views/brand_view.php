...
<?php $controller="brand";?>

<script>
    $().ready(function(){
		$('#Name').focus();
		$('#CompanyId').change(function(){
			$.post('<?php echo base_url()?>index.php/<?php echo $controller?>/ajaxsubbrand/'+ $('#CompanyId').val(),{},function(data){
				if(data)
				{
					$('#ajaxsub').html(data);
				}
		...
		<div class="navbar">
			<div class="navbar-inner">
				<ul class="breadcrumb">
					...
					<!------  Page Title  --------> 
					<li>
						<a href="<?php echo base_url()?>index.php/<?php echo $controller?>/index/">Add</a><span class="divider">/Brand</span>
					</li>
					<!------  Page Title  end  -------->
				</ul>
			</div>
					...
					?>
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/add">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td>Company </td>
										<td><?php echo form_dropdown('CompanyId', $carray,'0' ,"tabindex='2', id='CompanyId'");?></td>
									</tr>
									<!--<tr> <td>Sub-Brand </td> <td id="ajaxsub"><?phpform_dropdown('SubBrandId', $sarray,'0' ,"tabindex='3', id='SubBrandId'");?></td> </tr>-->
									<tr>
										<td>Description</td>
										<td><input type='text' name='Description' value='' maxlength='65535' tabindex='4' id='Description' /></td>
									</tr>
					...
					?>
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/edit_ac/">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td>Company </td>
										<td><?php echo form_dropdown('CompanyId', $carray,$CompanyId ,"tabindex='2', id='CompanyId'");?></td>
									</tr>
									<!--<tr> <td>Sub-Brand </td> <td id="ajaxsub"><?phpform_dropdown('SubBrandId', $sarray,$SubBrandId ,"tabindex='3', id='SubBrandId'");?></td> </tr>-->
									<tr>
										<td>Description</td>
										<td><input type='text' name='Description' value='<?php echo $Description;?>' maxlength='65535' tabindex='4' id='Description' /></td>
									</tr>
									<!-----  end of insert tr here      ------->
									<tr>
										<td  colspan="2" align="center">
