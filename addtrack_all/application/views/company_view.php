...
<?php $controller="company";?>

<script>
    $().ready(function(){
		$('#Name').focus();
		$('#BrandId').change(function(){
			$.post('<?php echo base_url()?>index.php/<?php echo $controller?>/getallsubbrand/',{'bid': $('#BrandId').val()},function(data){
				$('#sub').html(data);				
			})
		})
	})
		...
		<div class="navbar">
			<div class="navbar-inner">
				<ul class="breadcrumb">
					...
					<!------  Page Title  --------> 
					<li>
						<a href="<?php echo base_url()?>/index.php/<?php echo $controller?>/index/">Add</a><span class="divider">/Company</span>
					</li>
					<!------  Page Title  end  -------->
				</ul>
			</div>
					...
					?>
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/add">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td>Description</td>
										<td><textarea name='Description' tabindex='4' id='Description' ></textarea></td>
									</tr>
					...
					?>
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/edit_ac/">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td>Description</td>
										<td><textarea name='Description' tabindex='4' id='Description' ><?php echo $Description;?></textarea></td>
									</tr>
									<!-----  end of insert tr here      ------->
									<tr>
										<td  colspan="2" align="center" >
		...
		<div class="span12">
			...
			<div class="block">
				<div class="navbar navbar-inner block-header">
					...
					<div class="pull-right"><span class="badge badge-info">Total Record:  <?php echo $totalrow?></span>
				...
				<div class="block-content collapse in">
					<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/index/">
						...
						<table class="table table-striped"   width="100%">
							<tr>
								<td> <input type="text" value="<?php echo $search=='_'?'':$search;?>"  name="search" placeholder="Search Text" id="search" /> <input class="btn btn-success" type="submit" value="Search"  style="margin-bottom:10px;"  ></td>
