		...
		<div class="navbar">
			<div class="navbar-inner">
				<ul class="breadcrumb">
					...
					<!------  Page Title  --------> 
					<li>
						<a href="<?php echo base_url()?>index.php/<?php echo $controller?>/index/">Add</a><span class="divider">/ Product </span>
					</li>
					<!------  Page Title  end  -------->
				</ul>
			</div>
					...
					?>
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/add">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td>Product Cat</td>
										<td><?php echo form_dropdown('ProductId', $array,'0' ,"tabindex='1', id='ProductId'");?><font color="#FF0000">*</font></td>
									</tr>
									<tr>
										<td>Name Name</td>
										<td><input type='text' name='Name' value='' maxlength='50' tabindex='2' id='Name' /><font color="#FF0000">*</font></td>
									</tr>
									<tr>
										<td>Description</td>
										<td><input type='text' name='Description' value='' maxlength='65535' tabindex='3' id='Description' /></td>
									</tr>
					...
					?>
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/edit_ac/">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td>Product </td>
										<td><?php echo form_dropdown('ProductId', $array,$ProductId ,"tabindex='1', id='ProductId'");?><font color="#FF0000">*</font></td>
									</tr>
									<tr>
										<td>Name</td>
										<td><input type='text' name='Name' value='<?php echo $Name;?>' maxlength='50' tabindex='2' id='Name' /><font color="#FF0000">*</font></td> 
									</tr>
									<tr>
										<td>Description</td>
										<td><input type='text' name='Description' value='<?php echo $Description;?>' maxlength='65535' tabindex='3' id='Description' /></td>
									</tr>
									<!-----  end of insert tr here      ------->
									<tr>
										<td  colspan="2" align="center" >
