		...
		<div class="navbar">
			<div class="navbar-inner">
				<ul class="breadcrumb">
					...
					<!------  Page Title  --------> 
					<li><a href="<?php echo base_url()?>index.php/<?php echo $controller?>/index/">Add</a><span class="divider">/Media</span></li>
					<!------  Page Title  end  -------->
				</ul>
			</div>
		</div>
						...
						<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/add" enctype="multipart/form-data">
							<table class="table table-striped" width="100%">
								...
								<tr>
									<td>Owner</td>
									<td>
										<input type='text' name='Owner' value='' maxlength='50' tabindex='2' id='Owner' />
										<font  color="#FF0000">*</font>
									</td>
								</tr>
								...
								<tr>
									<td>Phone</td>
									<td><input type='text' name='Phone' value='' maxlength='50' tabindex='3' id='Phone' /></td>
								</tr>
								
								<tr>
									<td>Email</td>
									<td><input type='text' name='Email' value='' maxlength='100' tabindex='4' id='Email' /></td>
								</tr>
								
								<tr>
									<td>Address</td>
									<td><input type='text' name='Address' value='' maxlength='65535' tabindex='5' id='Address' /></td>
								</tr>
								
								<tr>
									<td>Image</td>
									<td>
										<input type='file' name='Image' value='' tabindex='5' id='Image' />
									</td>
								</tr>   
							...
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/edit_ac/" enctype="multipart/form-data">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td>Owner</td>
										<td>
											<input type='text' name='Owner' value='<?php echo $Owner;?>' maxlength='50' tabindex='2' id='Owner' />
											<font  color="#FF0000">*</font>
										</td>
									</tr>
									...
									<tr>
										<td>Phone</td>
										<td>
											<input type='text' name='Phone' value='<?php echo $Phone;?>' maxlength='50' tabindex='3' id='Phone' />
										</td>
									</tr>
									...
									<tr>
										<td>Email</td>
										<td>
											<input type='text' name='Email' value='<?php echo $Email;?>' maxlength='100' tabindex='4' id='Email' />
										</td>
									</tr>
									...
									<tr>
										<td>Address</td>
										<td>
											<input type='text' name='Address' value='<?php echo $Address;?>' maxlength='65535' tabindex='5' id='Address' />
										</td> 
									</tr> 
									<tr>
										<td>Image</td>
										<td>
											<input type='file' name='Image' value=''   tabindex='5' id='Image' /> <img src="<?php echo base_url()?>images/<?php echo $Image?>" alt="<?php echo $Image?>" width="150" />
											<input type='hidden' name='hidlogo' value='<?php echo $Image?>'   tabindex='5' id='hidlogo' />
										</td>
									</tr>  
									<!-----  end of insert tr here      ------->
									<tr>
				...
				<div class="block-content collapse in">
					<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/index/" enctype="multipart/form-data">
						<table class="table table-striped" width="100%">
							<tr>
								<td>
									<input type="text" value="<?php echo $search=='_'?'':$search;?>"  name="search" placeholder="Search Text" id="search" /> <input class="btn btn-success" type="submit" value="Search"  style="margin-bottom:10px;"  >
								</td>								
							</tr>
						</table>
					</form>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td>
											<img src="<?php echo base_url()?>images/<?php echo $row->Image?>" align="left" alt="<?php echo $row->Image?>" width="100" />
										</td> 
