...
<script>
	...
	function validation()
    {
		...
		if($('#Order').val()==''){alert('Please enter Order');$('#Order').focus();return false;  }
	}
						...
						<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/add">
							<table class="table table-striped" width="100%">
								...
								<tr> 
									<td> Name</td>
									<td>
										<input type='text' name='Name' value='' maxlength='200' tabindex='1' id='Name' />
								...
								<tr>
									<td> Url</td>
									<td>
										<input type='text' name='Url' value='' maxlength='200' tabindex='2' id='Url' />
										<font color="#FF0000">*</font>
									</td>
								</tr>
								<tr>
									<td>Order</td>
									<td>
										<input type='text' name='Order' value='' maxlength='11' tabindex='3' id='Order' />
										<font color="#FF0000">*</font>
									</td>
								</tr> 
								...
								<tr>
									<td  colspan="2" align="center" >
										<p>  								 
											<input type="submit" tabindex="4" value="Save" onclick="return validation()" class="btn btn-primary" />
							...
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/edit_ac/">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td> Name</td>
										<td>
											<input type='text' name='Name' value='<?php echo $Name?>' maxlength='200' tabindex='1' id='Name' />
											<font color="#FF0000">*</font>
										</td>
									</tr>
									<tr>
										<td> Url</td>
										<td>
											<input type='text' name='Url' value='<?php echo $Url?>' maxlength='200' tabindex='2' id='Url' />
											<font color="#FF0000">*</font>
										</td>
									</tr>
									<tr>
										<td>Order</td>
										<td>
											<input type='text' name='Order' value='<?php echo $Order?>' maxlength='11' tabindex='3' id='Order' />
											<font color="#FF0000">*</font>
										</td>
									</tr>
									<!-----  end of insert tr here      ------->
					...
					<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/delete/">
						<table class="table table-striped" id="table" width="100%">
							<thead>
								<tr>
									<th width="3%">SL</th>
									<th width="7%"><input type="checkbox" name="chk_all" id="chk_all" value="checkbox" onclick="checkall()"></th>
									<th width="7%"> Name</th>
									<th width="34%">URL </th>
