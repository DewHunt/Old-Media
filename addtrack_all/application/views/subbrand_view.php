		...
		<div class="navbar">
			<div class="navbar-inner">
				<ul class="breadcrumb">
					...
					<!------  Page Title  --------> 
					<li>
						<a href="<?php echo base_url()?>index.php/<?php echo $controller?>/index/">Add</a><span class="divider">/Sub-Brand</span>
					</li>
					<!------  Page Title  end  -------->
				</ul>
			</div>
					...
					?>
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/add">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td>Company</td>
										<td><?php echo form_dropdown('CompanyId', $carray,0 ,"tabindex='2'  id='CompanyId'");?><font color="#FF0000">*</font></td>
									</tr>
									<tr>
										<td >Brand</td>
										<td id="ajaxbrand"><?php echo form_dropdown('BrandId', $array,'0' ,"tabindex='3'  id='BrandId'");?><font color="#FF0000">*</font></td>
									</tr>
									<tr>
										<td>Description</td>
										<td>
											<textarea name='Description' value=''   tabindex='4' id='Description'></textarea>
										</td>
									</tr>
					...
					?>
							<form method="post" action="<?php echo base_url()?>index.php/<?php echo $controller?>/edit_ac/">
								<table class="table table-striped" width="100%">
									...
									<tr>
										<td>Company</td>
										<td><?php echo form_dropdown('CompanyId', $carray,$CompanyId ,"tabindex='1'  id='CompanyId'");?><font color="#FF0000">*</font></td>
									</tr>
									<tr>
										<td>Brand</td>
										<td id="ajaxbrand"><?php echo form_dropdown('BrandId', $barray,$BrandId ,"tabindex='1'  id='BrandId'");?><font color="#FF0000">*</font></td>
									</tr>
									<tr>
										<td>Name</td>
